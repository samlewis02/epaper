A Waveshare 4.2in display and a BME280 sensor are connected to a Raspberry Pi.
The display is used to show the following:
The current day and date, current time, exchange rate (GBP to TWD), Google
